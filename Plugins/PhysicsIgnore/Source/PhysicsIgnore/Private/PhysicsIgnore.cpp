...
#include "PhysicsIgnore.h"
#include "Physics/PhysicsFiltering.h"
#include "Engine/World.h"
#include "Engine.h"

#define LOCTEXT_NAMESPACE "FPhysicsIgnoreModule"
...
void FPhysicsIgnoreModule::StartupModule()
{
	// This code will execute after your module is loaded into memory; the exact timing is specified in the .uplugin file per-module
	
}

void FPhysicsIgnoreModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FPhysicsIgnoreModule, PhysicsIgnore)